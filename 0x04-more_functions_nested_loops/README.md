0- The file 0-isupper.c is a function that checks for uppercase character.
...
4- The file 4-print_most_numbers is a function that prints the numbers, from 0 to 9, followed by a new line.
